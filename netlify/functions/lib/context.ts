...
export const anuragContext = {
  ...
  professionalSummary: "AI Product Manager and Founder with 6+ years of experience spanning software engineering, embedded product ownership, and end-to-end AI product development. Independently conceived, built, and SOLO shipped multiple production AI products — a Chrome extension, a VS Code extension, and a Windows ambient AI assistant — reaching 5000+ users across 60+ countries within a month of launch, with zero paid acquisition. Deep hands-on expertise in generative AI, LLM product design, prompt engineering, retrieval-augmented generation, model evaluation, human-in-the-loop systems, multimodal AI, and voice AI pipelines. Combines a strong computer science foundation with OKR-driven roadmapping, data-driven prioritisation, and a consistent track record of shipping measurable outcomes. Equally comfortable defining product strategy with senior stakeholders and reviewing system architecture with engineering teams.",
  recruiterQuickPitch: "AI Product Manager with a software engineering foundation who ships — not just plans. I've independently launched multiple AI-native products used by 5000+ users globally, designed LLM evaluation frameworks in production, and built voice AI and ambient intelligence systems from scratch. I bring rare technical depth to product roles: I've written the TypeScript, wired the IPC pipelines, and optimised latency to under 200ms — while also owning the roadmap, the GTM, and the metrics. If you're hiring an AI PM who can hold their own with any engineering team and still drive product strategy, that's the intersection I operate in.",
  domainFocus: [
    "AI Product Management", "Generative AI Products", "LLM Workflow Design", "Voice AI & Multimodal Systems",
    "On-Device AI & Ambient Intelligence", "B2B SaaS AI Tools", "Developer Tooling", "0-to-1 Product Development"
  ],
  primaryExpertise: [
    "AI Product Strategy & Roadmapping", "LLM Feature Development", "Prompt Engineering & Optimisation", "Model Evaluation Frameworks",
    "Human-in-the-Loop AI Design", "Retrieval-Augmented Generation (RAG)", "Voice AI Pipelines (STT / TTS)", "Multimodal AI Systems",
    "On-Device AI & Privacy-First Architecture", "AI Behaviour Definition & Safety Guardrails", "Go-to-Market for AI Products", "Data-Driven Prioritisation"
  ],
  currentStatus: {
    role: "AI Product Manager",
    company: "Next Square Technologies",
    parallel: "Founder, Xenriq Systems",
    focus: "Leading development of internal AI productivity tools embedding LLM workflows for consulting and delivery teams, while concurrently building and shipping AI-native products under Xenriq Systems."
  },
  currentInterests: {
    openTo: "Senior AI Product Manager, Generative AI Product Lead, and AI Platform Product roles at companies building AI-first products, LLM-powered platforms, or developer/productivity tooling at scale.",
    collaborationStyle: "Thrives in product environments where teams solve ambiguous problems, run fast experiments, maintain high technical bar, and work closely with engineering to ship real AI systems — not just roadmaps."
  },
  impactHighlights: [
  ...
  products: [
    {
      ...
      summary: "Identified a high-friction gap in AI power-user workflows: professionals using Claude, ChatGPT, and Gemini lose context on every tab switch and start from zero at every session restart. Designed and shipped a dual-engine Chrome extension addressing this at the browser layer.",
      features: [
    ...
    },
    {
      ...
      summary: "Solved the developer AI prompt quality problem at the IDE layer: prompts sent to AI coding tools are context-poor, producing generic responses that require multiple iteration rounds per session — compounding productivity cost at scale.",
      features: [
    ...
    },
    {
      ...
      summary: "Ambient, screen-aware AI assistant with a hotkey-triggered voice interface. No subscriptions, no window switching, no context loss. Captures screen in real time, understands context via a multimodal AI pipeline, and responds by voice instantly.",
      features: [
  ...
  experience: [
    {
      ...
      summary: "Leading end-to-end product discovery, design, and delivery for an internal AI productivity platform targeting consulting and delivery teams.",
      highlights: [
      ...
      skills: ["AI Product Strategy", "LLM Workflows", "Prompt Engineering", "Model Evaluation", "Human-in-the-Loop Design", "PRDs", "Stakeholder Management", "Agile / Scrum"]
    },
    {
      company: "Xenriq Systems",
      ...
      summary: "Independently conceived, designed, built, and shipped 3 production AI-native products from zero to global traction. Operated across the full stack: product strategy, system architecture, LLM integration, GTM, and distribution — all solo.",
      highlights: [
      ...
      skills: ["0-to-1 Product Development", "LLM Integration", "Voice AI", "Multimodal AI", "On-Device AI", "Prompt Engineering", "System Architecture", "Electron/TypeScript", "Chrome Extension APIs", "VS Code Extension APIs", "Go-to-Market", "Product Marketing"]
    },
    {
      company: "Aithent Technologies",
      role: "Senior Software Engineer",
      duration: "Dec 2022 – Sep 2023",
      summary: "Product-embedded engineering role with full ownership of an LLM-powered intelligent search product — from model evaluation to production launch.",
      highlights: [
      ...
      skills: ["LLM Integration", "Model Evaluation Frameworks", "Backend Systems", "SLO Design", "Intelligent Search"]
    },
    {
      company: "Xoriant Solutions Pvt. Ltd.",
      role: "Software Engineer",
      duration: "Nov 2021 – Dec 2022",
      summary: "Built backend services and data-driven product features for financial platforms.",
      highlights: [
      ...
      skills: ["Backend Development", "APIs", "Data Pipelines", "Product Delivery", "Agile"]
    },
    {
      company: "Hexaware Technologies",
      role: "Associate Software Engineer",
      duration: "Jun 2019 – Nov 2021",
      summary: "Built operational analytics systems and contributed to user-research-driven product improvements.",
      highlights: [
  ...
  skills: {
    aiAndGenAI: [
      "Large Language Models (LLMs)", "Generative AI", "Prompt Engineering & Optimisation", "Retrieval-Augmented Generation (RAG)",
      "Model Evaluation & QA", "Human-in-the-Loop (HITL) Design", "AI Behaviour Definition", "Multimodal AI", "Voice AI (STT / TTS)",
      "On-Device AI Pipelines", "Screen-Aware AI", "Ambient AI Systems", "LLM Orchestration & Fallback Design"
    ],
    productManagement: [
      "AI Product Strategy", "0-to-1 Product Development", "Product Discovery & User Research", "Roadmapping & OKRs / KPIs",
      "PRDs & User Stories", "Feature Prioritisation (RICE, MoSCoW)", "Jobs-to-Be-Done (JTBD)", "MVP Scoping & Iteration",
      "Go-to-Market Strategy", "A/B Testing", "Stakeholder Management", "Agile & Scrum"
    ],
    technical: [
      "TypeScript", "Python", "JavaScript", "Java", "Electron", "WebSockets", "PCM Audio Streaming",
      "Chrome Extension APIs", "VS Code Extension APIs", "REST APIs", "Supabase", "SQL", "Git", "Cloudflare Workers", "ONNX Runtime", "Sharp"
    ],
    analytics: [
      "Google Analytics", "Mixpanel", "Amplitude", "Funnel Analysis", "Cohort Analysis", "Data-Driven Prioritisation", "SQL"
    ],
    tools: ["Figma", "Jira", "Linear", "Notion", "Postman", "GitHub", "AssemblyAI", "ElevenLabs"]
  },
  education: {
